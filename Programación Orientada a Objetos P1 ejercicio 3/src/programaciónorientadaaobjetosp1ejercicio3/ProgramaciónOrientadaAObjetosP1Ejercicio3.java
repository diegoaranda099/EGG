 ...
 */
package programaciónorientadaaobjetosp1ejercicio3;

import entidad.Operacion;


public class ProgramaciónOrientadaAObjetosP1Ejercicio3 {

    public static void main(String[] args) {
        Operacion m1= new Operacion();
        
        m1.crearOperacion();
        System.out.println("SUMA "+m1.suma());
        System.out.println("RESTA "+ m1.resta());
        System.out.println("MULTIPLICACION " + m1.multi());
        System.out.println("DIVIDIR "+m1.dividir());
    }
