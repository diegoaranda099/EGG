 ...
 */
package programación.orientada.a.objetos.p2.extras.ejercicio.pkg1;

import Servicio.RaicesServicio;

public class ProgramaciónOrientadaAObjetosP2ExtrasEjercicio1 {

    public static void main(String[] args) {
        RaicesServicio m1= new RaicesServicio();
